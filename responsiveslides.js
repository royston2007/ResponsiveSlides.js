...
(function ($, window, i) {
  $.fn.responsiveSlides = function (options) {
    ...
    // Default settings
    var settings = $.extend( {
      "play": true,                     // Boolean: Animate automatically, true or false
    ...
    return this.each(function () {
      ...
      if ($slide.size() > 1) {
        ...
        if(settings.pauseResume) {
          if(settings.play) {
            $pauseResume.append("<li><a href='#' class='PauseResume Resumed'>" + settings.pauseText + "</a></li>");
          } else {
          ...
          $pauseResume.find("a").bind("click", function(e) {
            ...
            if(settings.play) {
              $(this).text(settings.pauseText);
              $(this).addClass("Resumed");
              $(this).removeClass("Paused");
              restartCycle();
            } else {
              $(this).text(settings.resumeText);
